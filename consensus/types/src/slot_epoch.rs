...
#[derive(Eq, Clone, Copy, Default, Deserialize, Serialize)]
#[serde(transparent)]
pub struct Slot(#[serde(with = "crate::serde_utils::quoted")] u64);

#[cfg_attr(feature = "arbitrary-fuzz", derive(arbitrary::Arbitrary))]
#[derive(Eq, Clone, Copy, Default, Deserialize, Serialize)]
#[serde(transparent)]
pub struct Epoch(#[serde(with = "crate::serde_utils::quoted")] u64);
